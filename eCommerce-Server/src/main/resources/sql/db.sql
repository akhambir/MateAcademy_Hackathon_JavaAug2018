...
(
    ...
    CONSTRAINT USERS_ROLES_pkey PRIMARY KEY (FK_USER_ID, FK_ROLE_ID),
...
(
    ...
    CONSTRAINT PRODUCT_CODE_unique UNIQUE (PRODUCT_CODE),
...
(
    ...
    CONSTRAINT CARTS_PRODUCTS_pkey PRIMARY KEY (FK_CART_ID, FK_PRODUCT_ID),
